...
const timeInit = dateInit.toLocaleTimeString("en-us", {timeStyle: "short"})

//Generate & display the current time
function getCurrentTimeDate() {

    const date = new Date()
    const realTime = date.toLocaleTimeString("en-us", {timeStyle: "short"})
    const realDate = date.toDateString()
